...
Archived methodology: **V8.2**. This page is retained only as frozen migration evidence; current operations use `scripts/v10_cli.py` and V10 contracts. The identities below must not be used as defaults for a new run.
