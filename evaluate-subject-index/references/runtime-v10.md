...
[V10.2 decision contract](consequence-policy-v10.2.md), identity
`subject-index-evaluation-v10-decision-v3`, SHA-256
`779fb8ffb21bc17fe87a23ee9160a124e013a094c08280b7bdb26fef40d2da50`.
The earlier [V10 decision v1](consequence-policy-v10.md) and
[V10.1 decision v2](consequence-policy-v10.1.md) remain historical.
...
formulas, dimension caps, density bands and rounding. V10.2 has no overall-score
ceiling; publication gates remain separate from numeric scoring. No five-point aliases are accepted.
...
bindings, and stance/relationship findings require human re-adjudication. After
those facts are frozen, dimension scoring and public projection are mechanical.
