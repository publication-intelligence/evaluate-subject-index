...
class V8AdversarialMixtureTests(unittest.TestCase):
    ...
    def test_only_the_final_overall_percentage_is_rounded(self) -> None:
        ...
        patches = [
            ...
            mock.patch.object(v8.core, "calculate_coverage", return_value=dimensions[0]),
            mock.patch.object(v8.core, "calculate_selectivity", return_value=dimensions[1]),
            mock.patch.object(v8.core, "calculate_concept", return_value=dimensions[2]),
            mock.patch.object(v8.core, "calculate_findability", return_value=dimensions[4]),
            mock.patch.object(v8.core, "calculate_mechanics", return_value=dimensions[5]),
        ]
