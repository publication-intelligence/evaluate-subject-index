#!/usr/bin/env python3
"""Run the explicitly adopted V10 semantic correction; baseline v10_cli.py remains available.

Usage: v10_semantic_cli.py TOOL [arguments...]
...
TOOLS = {
    "adopt": "v10_execution.py", "state": "state_cli.py", "access-review": "v10_candidate_access.py", "release-decision": "v10_release.py",
...
def main():
    ...
    if args.tool == "study" and args.arguments and args.arguments[0] == "migrate-benchmark":
        parser.error("Migrate the preserved V8 predecessor with baseline v10_cli.py, then explicitly adopt this correction.")
