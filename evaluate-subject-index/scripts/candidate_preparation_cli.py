...
def load_source_identities(
    ...
    require(rubric_version == runtime_identity("subject-index-rubric-v8.2"), "rubric_identity_mismatch", "Candidate preparation requires the current V8 rubric identity.")
